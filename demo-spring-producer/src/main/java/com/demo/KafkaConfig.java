...
public class KafkaConfig {
  ...
  public Map<String, Object> consumerConfigs() {
    ...
    //Para usar a estrátegia de um grupo consumidor para cada replica habilitar essa linha e comentar a de baixo
    //props.put(ConsumerConfig.GROUP_ID_CONFIG, consumerGroup + "-"+ UUID.randomUUID().toString());
  ...
  public ConsumerFactory<String, String> consumerFactory() {
    final DefaultKafkaConsumerFactory<String, String> stringStringDefaultKafkaConsumerFactory =
